...
#define FIFOP_INT_INIT()            do { EICRB |= 0xC0; CLEAR_FIFOP_INT(); } while (0)

// FIFOP on external interrupt 0
#define ENABLE_FIFOP_INT()          do { EIMSK |= 0x80; } while (0)
#define DISABLE_FIFOP_INT()         do { EIMSK &= ~0x80; } while (0)
#define CLEAR_FIFOP_INT()           do { EIFR = 0x80; } while (0)
//-------------------------------------------------------------------------------------------------------
